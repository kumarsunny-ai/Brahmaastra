...
export const games: GameData[] = [
  {
    ...
    title: "Gilli Panda",
    emoji: "🏏",
    description: "A playful desi street-sport inspired browser game based on gilli danda mechanics.",
    longDescription:
      "Gilli Panda reimagines India's timeless Gilli-Danda as a fun, fast browser game. Set your power, choose your angle, and launch the gilli sky-high. Chase legendary distances and compete for high scores — all from your browser, no download needed.",
    status: "playable",
    ...
    featured: true,
    howToPlay: [
      "Tap once to set your power — watch the meter and time it right.",
      "Tap again to set the launch angle.",
      "Watch the gilli fly! The further it goes, the higher your score.",
      "Beat your high score and chase legendary distances.",
    ],
  },
  {
